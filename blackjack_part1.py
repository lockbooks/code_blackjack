...
def blackjack(dealer_hand, player_hand):
    ...
    if total(player_hand) == 21:
        ...
        print("Поздравляю! У вас блэкджек, вы выиграли!\n")
        wins += 1
    ...
    # проверяем очки раздающего на 21
        ...
        print_results(dealer_hand, player_hand)
        print("Простите, вы проиграли. У раздающего блэкджек.\n")
        losses += 1
        # предлагаем сыграть снова
        play_again()
        ...
        print("У вас и у раздающего блэкджек. В этом раунде победителя нет.\n")
        # предлагаем сыграть снова
        play_again()
